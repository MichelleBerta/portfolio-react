    ...
    <div className="container mt-8 id" id="about">
      ...
      <div className="col-s-12 col-lg-12 col-xl-12 pl-5 mt100 about-me">
        ...
        <p className="flow-text mb-5 mt-3 my-section">
          ...
          <br />
          <br />
          I am grateful for the opportunity I had to learn new technology and face new challenges as a bootcamp student. Adding my new coding knowledge to the skills I learned previously, will make me a valuable employee to any company. I am excited for the chance to take these combined skills and apply them. I will bring lots of energy and dedication to any team.
          <br />
          <br />
