          ...
          {workFull.map((workFull) => (
            <Card className="col-12 shadow p-3 mb-5 bg-white rounded" style={{ width: "30rem" }}>
              ...
              <Card.Body>
                ...
                <Button target="_blank" href={workFull.deployed}>
                  See the App
                </Button>

                <Button target="_blank" href={workFull.repo}>
                  See the Repo
                </Button>
              </Card.Body>
            </Card>
          ...
          {workBack.map((workBack) => (
            <Card className="col-12" style={{ width: "30rem" }}>
              <Card.Body>
                ...
                <Button target="_blank" href={workBack.repo}>
                  See the Repo
                </Button>
                <Button target="_blank" href={workBack.demo}>
                  See a Demo
                </Button>
              </Card.Body>
            </Card>
          ...
          {workFront.map((workFront) => (
            <Card className="col-12" style={{ width: "30rem" }}>
              ...
              <Card.Body>
                ...
                <Button target="_blank" href={workFront.repo}>
                  See the Repo
                </Button>
              </Card.Body>
            </Card>
